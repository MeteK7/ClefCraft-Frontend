...
export class MonthScrollViewComponent implements AfterViewInit, OnChanges, OnDestroy {
  ...
  private scrollToTargetDate(date: Date): void {
    ...
    // Target date isn't loaded — this is a "jump far away" case (e.g. datepicker
    // picked a date years out). Parent should re-initialize the window in this
    // case; we just no-op here and let windowChange/scrollToInitialPosition
    // handle it once the parent passes a freshly initialized window.
  }
